...
void OptimizeRtKlists ( const CSphString & sIndex, const CSphConfig & hConf )
{
	...
	while ( hConf["index"].IterateNext () )
	{
		...
		const ESphAttr iTypes[iNumTypes] = { ESphAttr::SPH_ATTR_INTEGER, ESphAttr::SPH_ATTR_BIGINT, ESphAttr::SPH_ATTR_FLOAT, ESphAttr::SPH_ATTR_TIMESTAMP, ESphAttr::SPH_ATTR_STRING };
