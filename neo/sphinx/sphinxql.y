	...
	ident '=' const_int
		{
			...
			if ( uHi )
			{
				...
				pParser->AddUpdatedAttr ( $1, ESphAttr::SPH_ATTR_BIGINT );
			} else
			{
				pParser->AddUpdatedAttr ( $1, ESphAttr::SPH_ATTR_INTEGER );
			}
		}
	| ident '=' const_float
		{
			...
			pParser->AddUpdatedAttr ( $1, ESphAttr::SPH_ATTR_FLOAT );
		}
	| ident '=' '(' const_list ')'
		{
...
alter_col_type:
	TOK_INTEGER 	{ $$.m_iValue = ESphAttr::SPH_ATTR_INTEGER; }
	| TOK_BIGINT	{ $$.m_iValue = ESphAttr::SPH_ATTR_BIGINT; }
	| TOK_FLOAT		{ $$.m_iValue = ESphAttr::SPH_ATTR_FLOAT; }
	| TOK_BOOL		{ $$.m_iValue = ESphAttr::SPH_ATTR_BOOL; }
	| TOK_MULTI		{ $$.m_iValue = ESphAttr::SPH_ATTR_UINT32SET; }
	| TOK_MULTI64	{ $$.m_iValue = ESphAttr::SPH_ATTR_INT64SET; }
	| TOK_JSON		{ $$.m_iValue = ESphAttr::SPH_ATTR_JSON; }
	| TOK_STRING	{ $$.m_iValue = ESphAttr::SPH_ATTR_STRING; }
	| TOK_INT		{ $$.m_iValue = ESphAttr::SPH_ATTR_INTEGER; }
	;
...
udf_type:
	...
	| TOK_BIGINT	{ $$.m_iValue = ESphAttr::SPH_ATTR_BIGINT; }
	| TOK_FLOAT		{ $$.m_iValue = ESphAttr::SPH_ATTR_FLOAT; }
	| TOK_STRING	{ $$.m_iValue = ESphAttr::SPH_ATTR_STRINGPTR; }
	| TOK_INTEGER	{ $$.m_iValue = ESphAttr::SPH_ATTR_INTEGER; }
	;
