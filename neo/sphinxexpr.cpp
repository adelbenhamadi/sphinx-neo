...
public:
	...
	virtual int StringEval ( const CSphMatch & tMatch, const BYTE ** ppStr ) const
	{
		...
		switch ( m_eArg )
		{
			case ESphAttr::SPH_ATTR_INTEGER:	m_sBuilder.Appendf ( "%u", m_pFirst->IntEval ( tMatch ) ); break;
			case ESphAttr::SPH_ATTR_BIGINT:	m_sBuilder.Appendf ( INT64_FMT, m_pFirst->Int64Eval ( tMatch ) ); break;
			case ESphAttr::SPH_ATTR_FLOAT:	m_sBuilder.Appendf ( "%f", m_pFirst->Eval ( tMatch ) ); break;
			...
			case ESphAttr::SPH_ATTR_INT64SET:
				{
					...
					assert (!( m_eArg==ESphAttr::SPH_ATTR_INT64SET && ( nValues & 1 ) ));

					// OPTIMIZE? minibuffer on stack, less allocs, manual formatting vs printf, etc
					if ( m_eArg==ESphAttr::SPH_ATTR_UINT32SET )
					{
						while ( nValues-- )
						{
...
public:
	...
	virtual int64_t DoEval ( ESphJsonType eJson, const BYTE * pVal, const CSphMatch & tMatch ) const
	{
		...
		ARRAY_FOREACH ( i, m_dRetTypes )
		{
			...
			{
			case ESphAttr::SPH_ATTR_INTEGER:	eJson = sphJsonFindByIndex ( eJson, &pVal, m_dArgs[i]->IntEval ( tMatch ) ); break;
			case ESphAttr::SPH_ATTR_BIGINT:	eJson = sphJsonFindByIndex ( eJson, &pVal, (int)m_dArgs[i]->Int64Eval ( tMatch ) ); break;
			case ESphAttr::SPH_ATTR_FLOAT:	eJson = sphJsonFindByIndex ( eJson, &pVal, (int)m_dArgs[i]->Eval ( tMatch ) ); break;
			case ESphAttr::SPH_ATTR_STRING:
				...
				break;
			case ESphAttr::SPH_ATTR_JSON_FIELD: // handle cases like "json.a [ json.b ]"
				{
...
class ExprParser_t;
	...
	#include "neo/sphinx/bissphinxexpr.h"
#else
	#include "neo/sphinx/yysphinxexpr.h"
#endif
...
{
	{ "now",			0,	FUNC_NOW,			ESphAttr::SPH_ATTR_INTEGER },

	{ "abs",			1,	FUNC_ABS,			ESphAttr::SPH_ATTR_NONE },
	{ "ceil",			1,	FUNC_CEIL,			ESphAttr::SPH_ATTR_BIGINT },
	{ "floor",			1,	FUNC_FLOOR,			ESphAttr::SPH_ATTR_BIGINT },
	{ "sin",			1,	FUNC_SIN,			ESphAttr::SPH_ATTR_FLOAT },
	{ "cos",			1,	FUNC_COS,			ESphAttr::SPH_ATTR_FLOAT },
	{ "ln",				1,	FUNC_LN,			ESphAttr::SPH_ATTR_FLOAT },
	{ "log2",			1,	FUNC_LOG2,			ESphAttr::SPH_ATTR_FLOAT },
	{ "log10",			1,	FUNC_LOG10,			ESphAttr::SPH_ATTR_FLOAT },
	{ "exp",			1,	FUNC_EXP,			ESphAttr::SPH_ATTR_FLOAT },
	{ "sqrt",			1,	FUNC_SQRT,			ESphAttr::SPH_ATTR_FLOAT },
	{ "bigint",			1,	FUNC_BIGINT,		ESphAttr::SPH_ATTR_BIGINT },	// type-enforcer special as-if-function
	{ "sint",			1,	FUNC_SINT,			ESphAttr::SPH_ATTR_BIGINT },	// type-enforcer special as-if-function
	{ "crc32",			1,	FUNC_CRC32,			ESphAttr::SPH_ATTR_INTEGER },
	{ "fibonacci",		1,	FUNC_FIBONACCI,		ESphAttr::SPH_ATTR_INTEGER },

	{ "day",			1,	FUNC_DAY,			ESphAttr::SPH_ATTR_INTEGER },
	{ "month",			1,	FUNC_MONTH,			ESphAttr::SPH_ATTR_INTEGER },
	{ "year",			1,	FUNC_YEAR,			ESphAttr::SPH_ATTR_INTEGER },
	{ "yearmonth",		1,	FUNC_YEARMONTH,		ESphAttr::SPH_ATTR_INTEGER },
	{ "yearmonthday",	1,	FUNC_YEARMONTHDAY,	ESphAttr::SPH_ATTR_INTEGER },
	{ "hour",			1,	FUNC_HOUR,			ESphAttr::SPH_ATTR_INTEGER },
	{ "minute",			1,	FUNC_MINUTE,		ESphAttr::SPH_ATTR_INTEGER },
	{ "second",			1,	FUNC_SECOND,		ESphAttr::SPH_ATTR_INTEGER },

	{ "min",			2,	FUNC_MIN,			ESphAttr::SPH_ATTR_NONE },
	{ "max",			2,	FUNC_MAX,			ESphAttr::SPH_ATTR_NONE },
	{ "pow",			2,	FUNC_POW,			ESphAttr::SPH_ATTR_FLOAT },
	{ "idiv",			2,	FUNC_IDIV,			ESphAttr::SPH_ATTR_NONE },

	{ "if",				3,	FUNC_IF,			ESphAttr::SPH_ATTR_NONE },
	{ "madd",			3,	FUNC_MADD,			ESphAttr::SPH_ATTR_NONE },
	{ "mul3",			3,	FUNC_MUL3,			ESphAttr::SPH_ATTR_NONE },

	{ "interval",		-2,	FUNC_INTERVAL,		ESphAttr::SPH_ATTR_INTEGER },
	{ "in",				-1, FUNC_IN,			ESphAttr::SPH_ATTR_INTEGER },
	{ "bitdot",			-1, FUNC_BITDOT,		ESphAttr::SPH_ATTR_NONE },
	{ "remap",			4,	FUNC_REMAP,			ESphAttr::SPH_ATTR_INTEGER },

	{ "geodist",		-4,	FUNC_GEODIST,		ESphAttr::SPH_ATTR_FLOAT },
	{ "exist",			2,	FUNC_EXIST,			ESphAttr::SPH_ATTR_NONE },
	{ "poly2d",			-1,	FUNC_POLY2D,		ESphAttr::SPH_ATTR_POLY2D },
	{ "geopoly2d",		-1,	FUNC_GEOPOLY2D,		ESphAttr::SPH_ATTR_POLY2D },
	{ "contains",		3,	FUNC_CONTAINS,		ESphAttr::SPH_ATTR_INTEGER },
	{ "zonespanlist",	0,	FUNC_ZONESPANLIST,	ESphAttr::SPH_ATTR_STRINGPTR },
	{ "to_string",		1,	FUNC_TO_STRING,		ESphAttr::SPH_ATTR_STRINGPTR },
	{ "rankfactors",	0,	FUNC_RANKFACTORS,	ESphAttr::SPH_ATTR_STRINGPTR },
	{ "packedfactors",	0,	FUNC_PACKEDFACTORS, ESphAttr::SPH_ATTR_FACTORS },
	{ "factors",		0,	FUNC_FACTORS,		ESphAttr::SPH_ATTR_FACTORS }, // just an alias for PACKEDFACTORS()
	{ "bm25f",			-2,	FUNC_BM25F,			ESphAttr::SPH_ATTR_FLOAT },
	{ "integer",		1,	FUNC_INTEGER,		ESphAttr::SPH_ATTR_BIGINT },
	{ "double",			1,	FUNC_DOUBLE,		ESphAttr::SPH_ATTR_FLOAT },
	{ "length",			1,	FUNC_LENGTH,		ESphAttr::SPH_ATTR_INTEGER },
	{ "least",			1,	FUNC_LEAST,			ESphAttr::SPH_ATTR_STRINGPTR },
	{ "greatest",		1,	FUNC_GREATEST,		ESphAttr::SPH_ATTR_STRINGPTR },
	{ "uint",			1,	FUNC_UINT,			ESphAttr::SPH_ATTR_INTEGER },

	{ "curtime",		0,	FUNC_CURTIME,		ESphAttr::SPH_ATTR_STRINGPTR },
	{ "utc_time",		0,	FUNC_UTC_TIME,		ESphAttr::SPH_ATTR_STRINGPTR },
	{ "utc_timestamp",	0,	FUNC_UTC_TIMESTAMP,	ESphAttr::SPH_ATTR_STRINGPTR },
	{ "timediff",		2,	FUNC_TIMEDIFF,		ESphAttr::SPH_ATTR_STRINGPTR },
	{ "current_user",	0,	FUNC_CURRENT_USER,	ESphAttr::SPH_ATTR_INTEGER },
	{ "connection_id",	0,	FUNC_CONNECTION_ID,	ESphAttr::SPH_ATTR_INTEGER },
	{ "all",			-1,	FUNC_ALL,			ESphAttr::SPH_ATTR_INTEGER },
	{ "any",			-1,	FUNC_ANY,			ESphAttr::SPH_ATTR_INTEGER },
	{ "indexof",		-1,	FUNC_INDEXOF,		ESphAttr::SPH_ATTR_BIGINT },

	{ "min_top_weight",		0,	FUNC_MIN_TOP_WEIGHT,	ESphAttr::SPH_ATTR_INTEGER },
	{ "min_top_sortval",	0,	FUNC_MIN_TOP_SORTVAL,	ESphAttr::SPH_ATTR_FLOAT },

	{ "atan2",			2,	FUNC_ATAN2,			ESphAttr::SPH_ATTR_FLOAT },
	{ "rand",			-1,	FUNC_RAND,			ESphAttr::SPH_ATTR_FLOAT }
};
...
{
	return eType==ESphAttr::SPH_ATTR_INTEGER || eType==ESphAttr::SPH_ATTR_BIGINT || eType==ESphAttr::SPH_ATTR_FLOAT;
}

/// check for type based on int value
static inline ESphAttr GetIntType ( int64_t iValue )
{
	return ( iValue>=(int64_t)INT_MIN && iValue<=(int64_t)INT_MAX ) ? ESphAttr::SPH_ATTR_INTEGER : ESphAttr::SPH_ATTR_BIGINT;
}
...
static inline ESphAttr WidestType ( ESphAttr a, ESphAttr b )
{
	...
	if ( a==ESphAttr::SPH_ATTR_FLOAT || b==ESphAttr::SPH_ATTR_FLOAT )
		return ESphAttr::SPH_ATTR_FLOAT;
	if ( a==ESphAttr::SPH_ATTR_BIGINT || b==ESphAttr::SPH_ATTR_BIGINT )
...
public:
	...
	ESphAttr				m_eRetType;		///< ESphAttr::SPH_ATTR_INTEGER, ESphAttr::SPH_ATTR_BIGINT, ESphAttr::SPH_ATTR_STRING, or ESphAttr::SPH_ATTR_FLOAT
	CSphString				m_sExpr;		///< m_sExpr copy for TOK_CONST_STRING evaluation

public:
	ConstList_c ()
		: m_eRetType ( ESphAttr::SPH_ATTR_INTEGER )
	{}

	void Add ( int64_t iValue )
	{
		if ( m_eRetType==ESphAttr::SPH_ATTR_FLOAT )
		{
	...
	void Add ( float fValue )
	{
		if ( m_eRetType!=ESphAttr::SPH_ATTR_FLOAT )
		{
			...
			m_dInts.Reset ();
			m_eRetType = ESphAttr::SPH_ATTR_FLOAT;
		}
...
struct ExprNode_t
{
	...
	ExprNode_t () : m_iToken ( 0 ), m_eRetType ( ESphAttr::SPH_ATTR_NONE ), m_eArgType ( ESphAttr::SPH_ATTR_NONE ),
...
int ExprParser_t::ParseAttr ( int iAttr, const char* sTok, YYSTYPE * lvalp )
{
	...
	{
	case ESphAttr::SPH_ATTR_FLOAT:		iRes = TOK_ATTR_FLOAT;	break;
	case ESphAttr::SPH_ATTR_UINT32SET:	iRes = TOK_ATTR_MVA32; break;
	case ESphAttr::SPH_ATTR_INT64SET:		iRes = TOK_ATTR_MVA64; break;
	case ESphAttr::SPH_ATTR_STRING:		iRes = TOK_ATTR_STRING; break;
	case ESphAttr::SPH_ATTR_JSON:			iRes = TOK_ATTR_JSON; break;
	case ESphAttr::SPH_ATTR_JSON_FIELD:	iRes = TOK_ATTR_JSON; break;
	case ESphAttr::SPH_ATTR_FACTORS:		iRes = TOK_ATTR_FACTORS; break;
...
public:
	...
	{
		assert ( pCall->m_pUdf->m_eRetType==ESphAttr::SPH_ATTR_INTEGER || pCall->m_pUdf->m_eRetType==ESphAttr::SPH_ATTR_BIGINT );
	}
...
public:
	explicit Expr_UdfFloat_c ( UdfCall_t * pCall, CSphQueryProfile * pProfiler )
		: Expr_Udf_c ( pCall, pProfiler )
	{
		assert ( pCall->m_pUdf->m_eRetType==ESphAttr::SPH_ATTR_FLOAT );
	}
...
public:
	explicit Expr_UdfStringptr_c ( UdfCall_t * pCall, CSphQueryProfile * pProfiler )
		: Expr_Udf_c ( pCall, pProfiler )
	{
		assert ( pCall->m_pUdf->m_eRetType==ESphAttr::SPH_ATTR_STRINGPTR );
	}
...
ISphExpr * ExprParser_t::CreateExistNode ( const ExprNode_t & tNode )
{
	...
	if ( iLoc>=0 )
	{
		...
		if ( tCol.m_eAttrType==ESphAttr::SPH_ATTR_UINT32SET || tCol.m_eAttrType==ESphAttr::SPH_ATTR_INT64SET || tCol.m_eAttrType==ESphAttr::SPH_ATTR_STRING )
		{
		...
		if ( tNode.m_eRetType==ESphAttr::SPH_ATTR_FLOAT )
			return new Expr_GetFloat_c ( tLoc, iLoc );
		else
			return new Expr_GetInt_c ( tLoc, iLoc );
	} else
	{
		if ( tNode.m_eRetType==ESphAttr::SPH_ATTR_INTEGER )
			return new Expr_GetIntConst_c ( (int)m_dNodes[iAttrDefault].m_iConst );
		else if ( tNode.m_eRetType==ESphAttr::SPH_ATTR_BIGINT )
...
ISphExpr * ExprParser_t::CreateContainsNode ( const ExprNode_t & tNode )
{
	...
	assert ( IsNumeric ( m_dNodes[iLat].m_eRetType ) );
	assert ( m_dNodes[iPoly].m_eRetType==ESphAttr::SPH_ATTR_POLY2D );
...
#define LOC_SPAWN_POLY(_classname) \
	if ( tNode.m_eArgType==ESphAttr::SPH_ATTR_INTEGER )		return new _classname##Int_c ( pLeft, pRight ); \
	else if ( tNode.m_eArgType==ESphAttr::SPH_ATTR_BIGINT )	return new _classname##Int64_c ( pLeft, pRight ); \
	...
	{
		if ( pLeft && m_dNodes[tNode.m_iLeft].m_eRetType==ESphAttr::SPH_ATTR_JSON_FIELD && m_dNodes[tNode.m_iLeft].m_iToken==TOK_ATTR_JSON )
			pLeft = new Expr_JsonFieldConv_c ( pLeft );
		if ( pRight && m_dNodes[tNode.m_iRight].m_eRetType==ESphAttr::SPH_ATTR_JSON_FIELD && m_dNodes[tNode.m_iRight].m_iToken==TOK_ATTR_JSON )
	...
	switch ( tNode.m_iToken )
	{
		...
		case TOK_EQ:			if ( ( m_dNodes[tNode.m_iLeft].m_eRetType==ESphAttr::SPH_ATTR_STRING ||
									m_dNodes[tNode.m_iLeft].m_eRetType==ESphAttr::SPH_ATTR_STRINGPTR ) &&
									( m_dNodes[tNode.m_iRight].m_eRetType==ESphAttr::SPH_ATTR_STRING ||
									m_dNodes[tNode.m_iRight].m_eRetType==ESphAttr::SPH_ATTR_STRINGPTR ) )
									return new Expr_StrEq_c ( pLeft, pRight, m_eCollation );
								else if ( ( m_dNodes[tNode.m_iLeft].m_eRetType==ESphAttr::SPH_ATTR_JSON_FIELD ) &&
									( m_dNodes[tNode.m_iRight].m_eRetType==ESphAttr::SPH_ATTR_STRING ||
									m_dNodes[tNode.m_iRight].m_eRetType==ESphAttr::SPH_ATTR_STRINGPTR ) )
									return new Expr_StrEq_c ( pLeft, pRight, m_eCollation );
		...
		case TOK_NOT:
			if ( tNode.m_eArgType==ESphAttr::SPH_ATTR_BIGINT )
		...
		case TOK_IS_NOT_NULL:
			if ( m_dNodes[tNode.m_iLeft].m_eRetType==ESphAttr::SPH_ATTR_JSON_FIELD )
...
public:
		...
		: Expr_ArgVsSet_c<T> ( pArg )
	{
		...
		if ( pConsts->m_eRetType==ESphAttr::SPH_ATTR_FLOAT )
		{
...
ISphExpr * ExprParser_t::CreateIntervalNode ( int iArgsNode, CSphVector<ISphExpr *> & dArgs )
{
	...
	if ( dTypes[0]==ESphAttr::SPH_ATTR_JSON_FIELD )
	...
	if ( bConst )
	{
		switch ( eAttrType )
		{
			case ESphAttr::SPH_ATTR_INTEGER:	return new Expr_IntervalConst_c<int> ( dArgs ); break;
			case ESphAttr::SPH_ATTR_BIGINT:	return new Expr_IntervalConst_c<int64_t> ( dArgs ); break;
	...
	} else
	{
		switch ( eAttrType )
		{
			case ESphAttr::SPH_ATTR_INTEGER:	return new Expr_Interval_c<int> ( dArgs ); break;
			case ESphAttr::SPH_ATTR_BIGINT:	return new Expr_Interval_c<int64_t> ( dArgs ); break;
		...
		case TOK_CONST_LIST:
			switch ( tLeft.m_iToken )
			{
				...
				default:
				{
					...
					{
						case ESphAttr::SPH_ATTR_INTEGER:	return new Expr_In_c<int> ( pArg, tRight.m_pConsts ); break;
						case ESphAttr::SPH_ATTR_BIGINT:	return new Expr_In_c<int64_t> ( pArg, tRight.m_pConsts ); break;
...
ISphExpr * ExprParser_t::CreateGeodistNode ( int iArgs )
{
	...
	{
		assert ( m_dNodes [ dArgs[4] ].m_eRetType==ESphAttr::SPH_ATTR_MAPARG );
...
ISphExpr * ExprParser_t::CreatePFNode ( int iArg )
{
	...
	{
		assert ( m_dNodes[dArgs[0]].m_eRetType==ESphAttr::SPH_ATTR_MAPARG );
...
ISphExpr * ExprParser_t::CreateBitdotNode ( int iArgsNode, CSphVector<ISphExpr *> & dArgs )
{
	...
	switch ( eAttrType )
	{
		case ESphAttr::SPH_ATTR_INTEGER:	return new Expr_Bitdot_c<int> ( dArgs ); break;
		case ESphAttr::SPH_ATTR_BIGINT:	return new Expr_Bitdot_c<int64_t> ( dArgs ); break;
...
#ifdef CMAKE_GENERATED_GRAMMAR
	#include "neo/sphinx/bissphinxexpr.c"
#else
	#include "neo/sphinx/yysphinxexpr.c"
#endif
...
{
	ESphAttr uLeftType = ( iLeft<0 ) ? ESphAttr::SPH_ATTR_INTEGER : m_dNodes[iLeft].m_eRetType;
	ESphAttr uRightType = ( iRight<0 ) ? ESphAttr::SPH_ATTR_INTEGER : m_dNodes[iRight].m_eRetType;

	ESphAttr uRes = ESphAttr::SPH_ATTR_FLOAT; // default is float
	if ( ( uLeftType==ESphAttr::SPH_ATTR_INTEGER || uLeftType==ESphAttr::SPH_ATTR_BIGINT ) &&
		( uRightType==ESphAttr::SPH_ATTR_INTEGER || uRightType==ESphAttr::SPH_ATTR_BIGINT ) )
	{
		// both types are integer (int32 or int64), compute in integers
		uRes = ( uLeftType==ESphAttr::SPH_ATTR_INTEGER && uRightType==ESphAttr::SPH_ATTR_INTEGER )
			? ESphAttr::SPH_ATTR_INTEGER
			: ESphAttr::SPH_ATTR_BIGINT;
	}

	// if json vs numeric then return numeric type (for the autoconversion)
	if ( uLeftType==ESphAttr::SPH_ATTR_JSON_FIELD && IsNumeric ( uRightType ) )
		uRes = uRightType;
	else if ( uRightType==ESphAttr::SPH_ATTR_JSON_FIELD && IsNumeric ( uLeftType ) )
		uRes = uLeftType;
...
int ExprParser_t::AddNodeFloat ( float fValue )
{
	...
	tNode.m_eRetType = ESphAttr::SPH_ATTR_FLOAT;
...
int ExprParser_t::AddNodeString ( int64_t iValue )
{
	...
	tNode.m_eRetType = ESphAttr::SPH_ATTR_STRING;
	tNode.m_iConst = iValue;
	return m_dNodes.GetLength()-1;
}
...
int ExprParser_t::AddNodeAttr ( int iTokenType, uint64_t uAttrLocator )
{
	...
	if ( iTokenType==TOK_ATTR_FLOAT )			tNode.m_eRetType = ESphAttr::SPH_ATTR_FLOAT;
	else if ( iTokenType==TOK_ATTR_MVA32 )		tNode.m_eRetType = ESphAttr::SPH_ATTR_UINT32SET;
	else if ( iTokenType==TOK_ATTR_MVA64 )		tNode.m_eRetType = ESphAttr::SPH_ATTR_INT64SET;
	else if ( iTokenType==TOK_ATTR_STRING )		tNode.m_eRetType = ESphAttr::SPH_ATTR_STRING;
	else if ( iTokenType==TOK_ATTR_FACTORS )	tNode.m_eRetType = ESphAttr::SPH_ATTR_FACTORS;
	else if ( iTokenType==TOK_ATTR_JSON )		tNode.m_eRetType = ESphAttr::SPH_ATTR_JSON_FIELD;
	else if ( tNode.m_tLocator.m_iBitCount>32 )	tNode.m_eRetType = ESphAttr::SPH_ATTR_BIGINT;
	else										tNode.m_eRetType = ESphAttr::SPH_ATTR_INTEGER;
	return m_dNodes.GetLength()-1;
}
...
int ExprParser_t::AddNodeID ()
{
	...
	tNode.m_eRetType = USE_64BIT ? ESphAttr::SPH_ATTR_BIGINT : ESphAttr::SPH_ATTR_INTEGER;
	return m_dNodes.GetLength()-1;
}
...
int ExprParser_t::AddNodeWeight ()
{
	...
	tNode.m_eRetType = ESphAttr::SPH_ATTR_INTEGER;
	return m_dNodes.GetLength()-1;
}
...
int ExprParser_t::AddNodeOp ( int iOp, int iLeft, int iRight )
{
	...
	// deduce type
	tNode.m_eRetType = ESphAttr::SPH_ATTR_FLOAT; // default to float
	if ( iOp==TOK_NEG )
	{
	...
	} else if ( iOp==TOK_NOT )
	{
		...
		tNode.m_eArgType = m_dNodes[iLeft].m_eRetType;
		tNode.m_eRetType = ESphAttr::SPH_ATTR_INTEGER;
		if (!( tNode.m_eArgType==ESphAttr::SPH_ATTR_INTEGER || tNode.m_eArgType==ESphAttr::SPH_ATTR_BIGINT ))
		{
		...
		|| iOp==TOK_IS_NULL || iOp==TOK_IS_NOT_NULL )
	{
		...
		if ( ( iOp==TOK_AND || iOp==TOK_OR || iOp=='&' || iOp=='|' )
			&& !( tNode.m_eArgType==ESphAttr::SPH_ATTR_INTEGER || tNode.m_eArgType==ESphAttr::SPH_ATTR_BIGINT ))
		{
	...
	{
		if ( m_dNodes[iRight].m_eRetType==ESphAttr::SPH_ATTR_STRING && m_dNodes[iLeft].m_iToken==TOK_IDENT )
			m_dNodes[iLeft].m_eRetType = ESphAttr::SPH_ATTR_STRING;
		else if ( m_dNodes[iLeft].m_eRetType==ESphAttr::SPH_ATTR_STRING && m_dNodes[iRight].m_iToken==TOK_IDENT )
			m_dNodes[iRight].m_eRetType = ESphAttr::SPH_ATTR_STRING;
	}
...
int ExprParser_t::AddNodeFunc ( int iFunc, int iFirst, int iSecond, int iThird, int iFourth )
{
	...
	if ( iSecond<0 )
	{
		...
		{
			bGotString |= ( dRetTypes[i]==ESphAttr::SPH_ATTR_STRING );
			bGotMva |= ( dRetTypes[i]==ESphAttr::SPH_ATTR_UINT32SET || dRetTypes[i]==ESphAttr::SPH_ATTR_INT64SET );
		}
	}
	...
	if ( eFunc==FUNC_BITDOT )
	{
		...
		if ( eArg!=ESphAttr::SPH_ATTR_INTEGER && eArg!=ESphAttr::SPH_ATTR_BIGINT )
		{
	...
	if ( eFunc==FUNC_EXIST )
	{
		...
		bool bIsLeftGood = ( m_dNodes [ iExistLeft ].m_eRetType==ESphAttr::SPH_ATTR_STRING );
		ESphAttr eRight = m_dNodes [ iExistRight ].m_eRetType;
		bool bIsRightGood = ( eRight==ESphAttr::SPH_ATTR_INTEGER || eRight==ESphAttr::SPH_ATTR_TIMESTAMP || eRight==ESphAttr::SPH_ATTR_BOOL
			|| eRight==ESphAttr::SPH_ATTR_FLOAT || eRight==ESphAttr::SPH_ATTR_BIGINT );
	...
	{
		assert ( iFirst>=0 );
		if ( m_dNodes [ iFirst ].m_eRetType!=ESphAttr::SPH_ATTR_INTEGER )
		{
	...
	if ( eFunc==FUNC_CONTAINS )
	{
		...
		if ( dRetTypes[0]!=ESphAttr::SPH_ATTR_POLY2D )
		{
	...
	if ( eFunc==FUNC_POLY2D || eFunc==FUNC_GEOPOLY2D )
	{
		if ( dRetTypes.GetLength()==1 )
		{
			...
			if ( dRetTypes[0]!=ESphAttr::SPH_ATTR_STRING )
			{
	...
	if ( eFunc==FUNC_BM25F )
	{
		...
		if ( dRetTypes[0]!=ESphAttr::SPH_ATTR_FLOAT || dRetTypes[1]!=ESphAttr::SPH_ATTR_FLOAT )
		{
			m_sParserError.SetSprintf ( "%s() arguments 1,2 must be numeric", sFuncName );
			return -1;
		}

		if ( dRetTypes.GetLength()==3 && dRetTypes[2]!=ESphAttr::SPH_ATTR_MAPARG )
		{
	...
	if ( eFunc==FUNC_GEODIST )
	{
		...
		if ( dRetTypes.GetLength()==5 && dRetTypes[4]!=ESphAttr::SPH_ATTR_MAPARG )
		{
	...
	if ( eFunc==FUNC_REMAP )
	{
		...
		if ( eFirstRet!=ESphAttr::SPH_ATTR_INTEGER && eFirstRet!=ESphAttr::SPH_ATTR_BIGINT )
		{
			m_sParserError.SetSprintf ( "%s() first argument should result in integer value", sFuncName );
			return -1;
		}
		if ( eSecondRet!=ESphAttr::SPH_ATTR_INTEGER && eSecondRet!=ESphAttr::SPH_ATTR_BIGINT && eSecondRet!=ESphAttr::SPH_ATTR_FLOAT )
		{
		...
		if ( eSecondRet==ESphAttr::SPH_ATTR_FLOAT && tFourthList.m_dFloats.GetLength()==0 )
		{
		...
		if ( eSecondRet!=ESphAttr::SPH_ATTR_FLOAT && tFourthList.m_dInts.GetLength()==0 )
		{
	...
	tNode.m_eArgType = ( iFirst>=0 ) ? m_dNodes [ iFirst ].m_eRetType : ESphAttr::SPH_ATTR_INTEGER;
	...
	if ( eFunc==FUNC_BIGINT && tNode.m_eRetType==ESphAttr::SPH_ATTR_FLOAT )
		tNode.m_eRetType = ESphAttr::SPH_ATTR_FLOAT; // enforce if we can; FIXME! silently ignores BIGINT() on floats; should warn or raise an error
	...
	if ( eFunc==FUNC_GREATEST || eFunc==FUNC_LEAST )
	{
		...
		while ( m_dNodes [ iLeftmost ].m_iToken==',' )
			iLeftmost = m_dNodes [ iLeftmost ].m_iLeft;
		ESphAttr eArg = m_dNodes [ iLeftmost ].m_eRetType;
		if ( eArg==ESphAttr::SPH_ATTR_INT64SET )
			tNode.m_eRetType = ESphAttr::SPH_ATTR_BIGINT;
		if ( eArg==ESphAttr::SPH_ATTR_UINT32SET )
			tNode.m_eRetType = ESphAttr::SPH_ATTR_INTEGER;
	}
	...
	// all ok
	assert ( tNode.m_eRetType!=ESphAttr::SPH_ATTR_NONE );
	return m_dNodes.GetLength()-1;
}
...
int ExprParser_t::AddNodeUdf ( int iCall, int iArg )
{
	...
	if ( iArg>=0 )
	{
		...
		while ( iCur>=0 )
		{
			if ( m_dNodes[iCur].m_iToken!=',' )
			{
				...
				if ( tNode.m_eRetType==ESphAttr::SPH_ATTR_JSON || tNode.m_eRetType==ESphAttr::SPH_ATTR_JSON_FIELD )
					pCall->m_dArgs2Free.Add ( dArgTypes.GetLength() );
	...
	// deduce type
	tNode.m_eArgType = ( iArg>=0 ) ? m_dNodes[iArg].m_eRetType : ESphAttr::SPH_ATTR_INTEGER;
...
int	ExprParser_t::AddNodePF ( int iFunc, int iArg )
{
	...
	if ( dRetTypes.GetLength()==1 && dRetTypes[0]!=ESphAttr::SPH_ATTR_MAPARG )
	{
	...
	tNode.m_iLeft = iArg;
	tNode.m_iRight = -1;
	tNode.m_eArgType = ESphAttr::SPH_ATTR_MAPARG;
	tNode.m_eRetType = g_dFuncs[iFunc].m_eRet;
...
int ExprParser_t::AddNodeHookFunc ( int iID, int iLeft )
{
	...
	if ( eRet==ESphAttr::SPH_ATTR_NONE )
		return -1;
	...
	// deduce type
	tNode.m_eArgType = ( iLeft>=0 ) ? m_dNodes[iLeft].m_eRetType : ESphAttr::SPH_ATTR_INTEGER;
...
int ExprParser_t::AddNodeMapArg ( const char * sKey, const char * sValue, int64_t iValue )
{
	...
	tNode.m_eRetType = ESphAttr::SPH_ATTR_MAPARG;
	return m_dNodes.GetLength()-1;
}
...
int ExprParser_t::AddNodeIdent ( const char * sKey, int iLeft )
{
	...
	tNode.m_eRetType = ESphAttr::SPH_ATTR_JSON_FIELD;
	return m_dNodes.GetLength()-1;
}
...
struct TypeCheck_fn
{
	...
	void Enter ( const ExprNode_t & tNode, const CSphVector<ExprNode_t> & dNodes )
	{
		...
		if ( bNumberOp )
		{
			...
			if ( ( bLeftNumeric && dNodes[tNode.m_iRight].m_eRetType==ESphAttr::SPH_ATTR_JSON_FIELD )
				|| ( bRightNumeric && dNodes[tNode.m_iLeft].m_eRetType==ESphAttr::SPH_ATTR_JSON_FIELD ) )
					return;
		...
		if ( tNode.m_iToken==TOK_EQ )
		{
			...
			ESphAttr eLeftRet = tNode.m_iLeft==-1 ? ESphAttr::SPH_ATTR_NONE : dNodes[tNode.m_iLeft].m_eRetType;
			ESphAttr eRightRet = tNode.m_iRight==-1 ? ESphAttr::SPH_ATTR_NONE : dNodes[tNode.m_iRight].m_eRetType;
			bool bLeftStr = ( eLeftRet==ESphAttr::SPH_ATTR_STRING || eLeftRet==ESphAttr::SPH_ATTR_STRINGPTR || eLeftRet==ESphAttr::SPH_ATTR_JSON_FIELD );
			bool bRightStr = ( eRightRet==ESphAttr::SPH_ATTR_STRING || eRightRet==ESphAttr::SPH_ATTR_STRINGPTR || eRightRet==ESphAttr::SPH_ATTR_JSON_FIELD );
			if ( bLeftStr!=bRightStr && eLeftRet!=ESphAttr::SPH_ATTR_JSON_FIELD && eRightRet!=ESphAttr::SPH_ATTR_JSON_FIELD )
			{
	...
	{
		return tNode.m_eRetType==ESphAttr::SPH_ATTR_INTEGER || tNode.m_eRetType==ESphAttr::SPH_ATTR_BOOL || tNode.m_eRetType==ESphAttr::SPH_ATTR_FLOAT ||
			tNode.m_eRetType==ESphAttr::SPH_ATTR_BIGINT || tNode.m_eRetType==ESphAttr::SPH_ATTR_TOKENCOUNT || tNode.m_eRetType==ESphAttr::SPH_ATTR_TIMESTAMP;
	}
};
...
#define SPH_EXPRNODE_STACK_SIZE 160
	...
	{
		sError.SwapWith ( tTypeChecker.m_sError );
		return NULL;
	}
